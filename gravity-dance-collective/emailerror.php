...
<html lang="en">
  <head>
     <meta charset="utf-8">
      <meta name="description" content="gravity-dance-collective-home">
...
<!-- OOPS-->
        ...
        <div class="Col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<p class="textlanding">
            <p  class="center">Oops! Something has gone wrong, please try submitting your form again or reach out directly to <a href="mailto:gravitydance2013@gmail.com"><strong>Nicole</strong></a>. </p>
          </p>
        </div>
			</div>
	   </div>
