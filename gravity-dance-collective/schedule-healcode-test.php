...
<html lang="en">
  <head>
     <meta charset="utf-8">
      <meta name="description" content="Gravity Dance Collective Denver school class schedule adults and kids and registration portal">
     <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <meta name="viewport" content="width=device-width, initial-scale=1">
     <title>GDC | Class Schedule</title>
...
<healcode-widget data-type="schedules" data-widget-partner="mb" data-widget-id="9734719b0d7" data-widget-version="0.1"></healcode-widget>
	 			</div>
	 		</div>
	 	</div>
	 	<div class="container">
	 	...
	 	<div class="container">
				...
				<div class="row">
						...
						<div class="Col-xs-12 col-sm-6 col-md-6 col-lg-6" style="margin-top: 35px">
							...
							<p style="font-style:italic">Add $20 per month for each additional class.
							</p>
						</div>
				</div>
				<div class="row">
